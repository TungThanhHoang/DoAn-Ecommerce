...
function DetailUser() {
  const {
    authState: {
      user: { firstname , lastname , email ,ward, district ,address},
    },
      ...
      <div className="wrap-detail">
        <div className="name-user">
          <div className="card-item">
            ...
            <input className="input-field" type="text" value={firstname} name="firstname" onChange={handleOnChange} />
          </div>
          <div className="card-item">
            <label className="title-input">Họ</label>
            <input className="input-field" type="text" name="lastname" onChange={handleOnChange} />
          </div>
        </div>
        <div className="card-item">
          <label className="title-input">Email</label>
          <input className="input-field" value={email} disabled type="text" name="email" id="" />
        </div>
        <div className="card-item">
          <label className="title-input">Phone</label>
          <input className="input-field" type="text" name="phone" id=""  onChange={handleOnChange}/>
        </div>
        <div className="address-user">
          <div className="card-item">
            <div className="title-input">Số nhà</div>
            <input className="input-field" type="text" name="address" id="" onChange={handleOnChange}/>
          </div>
          <div className="card-item">
